...
describe SearchVrnForm, type: :model do
  ...
  context 'when vrn is nil' do
    ...
    it_behaves_like 'an invalid VrnForm', I18n.t('search_vrn_form.errors.vrn_missing')
  end

  context 'when vrn is too short' do
    let(:vrn) { 'A' }

    it_behaves_like 'an invalid VrnForm', I18n.t('search_vrn_form.errors.vrn_too_short')
  end

  context 'when vrn is too long' do
    let(:vrn) { 'AAAAAAAA' }

    it_behaves_like 'an invalid VrnForm', I18n.t('search_vrn_form.errors.vrn_too_long')
  end

  context 'when vrn is in invalid format' do
    let(:vrn) { 'AAAAA' }

    it_behaves_like 'an invalid VrnForm', I18n.t('search_vrn_form.errors.vrn_invalid')
  end
end
