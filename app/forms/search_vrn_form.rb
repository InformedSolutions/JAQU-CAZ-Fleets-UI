...
##
# The form used to validate search vrn input on payament matrix.
#
class SearchVrnForm < BaseForm
  ...
  validates :vrn, presence: {
    message: I18n.t('search_vrn_form.errors.vrn_missing')
  }

  validates :vrn, length: {
    minimum: 2,
    maximum: 7,
    too_short: I18n.t('search_vrn_form.errors.vrn_too_short'),
    too_long: I18n.t('search_vrn_form.errors.vrn_too_long')
  }
  ...
  def validate_format
    ...
    errors.add(:vrn, I18n.t('search_vrn_form.errors.vrn_invalid'))
  end
